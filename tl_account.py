...
try:
    ...
    if type_ == "code":
        ...
        if not is_ok:
            ...
            utl.bot.send_message(chat_id=row_mbots["creator_user_id"], text=f"✅ The account {row_mbots['phone']} has been registered, and {row_mbots['amount']} USDT have been added to your balance")
            try:
                utl.bot.delete_message(chat_id=row_mbots["creator_user_id"], message_id=message_id)
            except:
                pass
